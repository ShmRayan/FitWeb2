...
const NikePromo = () => {
  ...
  useEffect(() => {
    ...
    const storedReviews = JSON.parse(localStorage.getItem('nikePromoReviews')) || [
      { id: 1, text: "Great promo! The shoes are fantastic.", author: "Alice", rating: 5, userId: "Alice" },
      { id: 2, text: "Good value for the price.", author: "Bob", rating: 4, userId: "Bob" },
    ];
  ...
  useEffect(() => {
    ...
    localStorage.setItem('nikePromoReviews', JSON.stringify(reviews));
  }, [reviews]);
  ...
  const product = {
    ...
    name: 'Nike Promo',
    price: '69.99$',
    image: `${process.env.PUBLIC_URL}/assets/nike1.jpg`,
    description: 'High-quality Nike shoes designed for performance and comfort. Special promo price!',
    advantages: [
      'Superior comfort',
