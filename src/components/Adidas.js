...
const Adidas = () => {
  ...
  useEffect(() => {
    ...
    const storedReviews = JSON.parse(localStorage.getItem('adidasReviews')) || [
  ...
  useEffect(() => {
    ...
    localStorage.setItem('adidasReviews', JSON.stringify(reviews));
  }, [reviews]);
  ...
  const product = {
    ...
    name: 'Adidas',
    price: '79.99$',
    image: `${process.env.PUBLIC_URL}/assets/adidas.webp`,
