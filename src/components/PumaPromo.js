...
const PumaPromo = () => {
  ...
  useEffect(() => {
    ...
    const storedReviews = JSON.parse(localStorage.getItem('pumaPromoReviews')) || [
      { id: 1, text: "These Puma shoes are fantastic!", author: "Alice", rating: 5, userId: "Alice" },
      { id: 2, text: "Great value for the promo price.", author: "Bob", rating: 4, userId: "Bob" },
    ];
  ...
  useEffect(() => {
    ...
    localStorage.setItem('pumaPromoReviews', JSON.stringify(reviews));
  }, [reviews]);
  ...
  const product = {
    ...
    name: 'Puma Promo',
    price: '69.99$',
    image: `${process.env.PUBLIC_URL}/assets/puma1.webp`,
    description: 'Experience the best with Puma shoes, known for their excellent quality and design. Special promo price!',
    advantages: [
      'Exceptional comfort',
      'Durable materials',
      'Modern look',
