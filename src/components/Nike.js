...
const Nike = () => {
  ...
  useEffect(() => {
    ...
    const storedReviews = JSON.parse(localStorage.getItem('nikeReviews')) || [
      { id: 1, text: "Excellent shoes! Very comfortable.", author: "John", rating: 5, userId: "John" },
      { id: 2, text: "Great for running. Would buy again.", author: "Jane", rating: 4, userId: "Jane" },
    ];
  ...
  useEffect(() => {
    ...
    localStorage.setItem('nikeReviews', JSON.stringify(reviews));
  }, [reviews]);
  ...
  const product = {
    ...
    name: 'Nike',
    price: '79.99$',
    image: `${process.env.PUBLIC_URL}/assets/nike.jpg`,
    description: 'High-quality Nike shoes designed for performance and comfort.',
    advantages: [
      'Superior comfort',
